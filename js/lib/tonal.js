var Tonal = (function () {
      ...
      "string" == typeof e
        ? (function (e) {
            ...
            const t = n[0],
              ...
              i = P(r),
              c = o.length ? +o : void 0,
              u = m({ step: a, alt: i, oct: c }),
              l = t + r + o,
              d = t + r,
              M = (y[a] + i + 120) % 12,
              f =
                void 0 === c
                  ? ((g = y[a] + i), (A = 12), (((g % A) + A) % A) - 1188)
                  : y[a] + i + 12 * (c + 1),
              h = f >= 0 && f <= 127 ? f : null,
            ...
            const i = "M" === a ? "majorable" : "perfectable",
              ...
              l = (function (e, n) {
                return ("M" === n && "majorable" === e) ||
                  ...
                  ? n.length
                  : /^d+$/.test(n)
                  ? -1 * ("perfectable" === e ? n.length : n.length + 1)
                  : 0;
              })(i, r),
              d = Math.floor((Math.abs(t) - 1) / 7),
              P = s * (I[o] + l + 12 * d),
              M = (((s * (I[o] + l)) % 12) + 12) % 12,
              f = m({ step: o, alt: l, oct: d, dir: s });
            return {
              empty: !1,
              name: c,
              num: t,
  ...
  function $(e) {
    ...
    return (
      ("b" === r[0] ? r.replace(/b/g, "_") : r.replace(/#/g, "^")) +
      (o > 4 ? t.toLowerCase() : t) +
      (5 === o ? "" : o > 4 ? D("'", o - 5) : D(",", 4 - o))
    );
  }
  ...
  var E = Object.freeze({
    ...
    shuffle: function (e, n = Math.random) {
      let t,
        ...
        o = e.length;
      for (; o; )
        (t = Math.floor(n() * o--)), (r = e[o]), (e[o] = e[t]), (e[t] = r);
      return e;
    },
    sortedNoteNames: k,
  ...
  function se(e, n, t) {
    const r = (function (e) {
      ...
      o = { ...J(e), name: t || "", quality: r, intervals: e, aliases: n };
    re.push(o),
      o.name && (oe[o.name] = o),
      (oe[o.setNum] = o),
      (oe[o.chroma] = o),
  ...
  ].forEach(([e, n, t]) => se(e.split(" "), t.split(" "), n)),
    re.sort((e, n) => e.setNum - n.setNum);
  var ue = {
    names: function () {
                ...
                ie()
                  ...
                  .forEach((e) => {
                    const i = e.aliases[0],
                      c = o(a);
                    a !== r
                      ? m.push({ weight: 0.5 * n, name: `${c}${i}/${t}` })
                      : m.push({ weight: 1 * n, name: `${c}${i}` });
                  });
              }),
              m
            );
  ...
  function De(e) {
    const [n, t, r] = we.exec(e) || [],
      o = xe.find((e) => e.shorthand === t || e.names.includes(t));
    if (!o) return Te;
  ...
  function un(e, n) {
    ...
    if (t.empty) return "";
    const r = en(
      n || Qe(t.midi || t.chroma, { sharps: t.alt < 0, pitchClass: !0 })
    );
  ...
  const dn = { empty: !0, name: "", chordType: "" },
    Pn = {};
  function Mn(e) {
  ...
  const An = Object.freeze([]),
    vn = { type: "major", tonic: "", alteration: 0, keySignature: "" },
    jn = {
      tonic: "",
      grades: An,
      intervals: An,
  ...
  function Ln(e) {
    const n = z(e.map(Be));
    return e.length && n.length === e.length
      ? n.reduce(
          (e, n) => {
